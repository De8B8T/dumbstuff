...
local function announce(sender, player, message)
	...
	-- StarterGui.Announcement.TopBar
	...
	-- StarterGui.Announcement.TopBar.MFrame
	...
	-- StarterGui.Announcement.TopBar.MFrame.TextLabel
	...
	-- Adjust TextSize based on the length of the message
	if #message > 40 then
		G2L["4"]["TextSize"] = 12;
	...
	-- StarterGui.Announcement.TopBar.Close
	...
	-- StarterGui.Announcement.TopBar.Uame
